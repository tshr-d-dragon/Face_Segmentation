...
def ASPP(image_features):
  ...
  y_1 = Conv2D(filters=64, kernel_size=1, padding='same', use_bias=False)(image_features)
  y_1 = BatchNormalization(name=f'bn_2')(y_1)
  y_1 = Activation('relu', name=f'relu_2')(y_1)

  y_6 = Conv2D(filters=64, kernel_size=3, padding='same', dilation_rate = 2,use_bias=False)(image_features)
  y_6 = BatchNormalization(name=f'bn_3')(y_6)
  y_6 = Activation('relu', name=f'relu_3')(y_6)

  y_12 = Conv2D(filters=64, kernel_size=3, padding='same', dilation_rate = 4,use_bias=False)(image_features)
  y_12 = BatchNormalization(name=f'bn_4')(y_12)
  y_12 = Activation('relu', name=f'relu_4')(y_12)

  y_18 = Conv2D(filters=64, kernel_size=3, padding='same', dilation_rate = 6,use_bias=False)(image_features)
  y_18 = BatchNormalization(name=f'bn_5')(y_18)
  y_18 = Activation('relu', name=f'relu_5')(y_18)

  y_c = Concatenate()([y_pool, y_1, y_6, y_12, y_18])

  y = Conv2D(filters=64, kernel_size=1, padding='same', use_bias=False)(y_c)
...
def DeepLabV3Plus(inputs, classes=1):
    ...
    x_b = Conv2D(filters=64, kernel_size=1, padding='same', use_bias=False)(low_level_image_features)
