...
def PSPNet(inputs, classes=100):
    ...
    base_model_features = Conv2D(128, (1, 1), use_bias=False)(base_model_features)
    base_model_features = BatchNormalization()(base_model_features)
    base_model_features = Activation('relu')(base_model_features)

    x = Pyramid_Pooling_Module(base_model_features, f=32, p1=2, p2=4, p3=8)
